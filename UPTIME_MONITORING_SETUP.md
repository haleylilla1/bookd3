...
- **URL**: `https://bookd.tools/health` (production) or `https://your-replit-url/health` (dev)
...
- **URL**: `https://bookd.tools/api/health/database`
...
- **URL**: `https://bookd.tools/api/health/auth`
...
- **URL**: `https://bookd.tools/api/health/core`
